...
fig_map = px.scatter_mapbox(df2, lat="lat", lon="lng", hover_name="nom_long",
                            hover_data=["Geo_Point", "exploitant"],
...
# Ajouter une colonne de couleurs pour chaque ligne
color_dict = {'1': 'blue', '2': 'yellow', '3': 'green', '3bis': 'lightgreen',
              '4': 'fuchsia', '5': 'orange', '6': 'grey', '7': 'brown',
              '7bis': 'lightbrown', '8': 'pink', '9': 'purple', '10': 'darkgreen',
              '11': 'darkgrey', '12': 'lightblue', '13': 'darkblue', '14': 'red'}
df2['color'] = df2['ligne'].map(color_dict)
